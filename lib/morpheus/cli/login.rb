...
class Morpheus::Cli::Login
  ...
  def login(args)
    ...
    optparse = Morpheus::Cli::OptionParser.new do |opts|
      ...
      opts.on( '--client-id CLIENT', "Used to test authentication with a client_id other than morph-cli. Currently treated like --test, credentials are not stored." ) do |val|
